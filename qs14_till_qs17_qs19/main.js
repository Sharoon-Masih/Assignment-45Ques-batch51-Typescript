...
var like = ['Benny', 'Aleem', 'Danish', 'Shaleem', 'Faisal'];
like.map(function (person) {
    console.log("Hey ".concat(person, ", I would like to invite you to the Dinner tonight "));
});
console.log('\n');
...
var filter = like.filter(function (person) { return person !== cannotAttend; });
filter.map(function (person) {
    console.log("Hey ".concat(person, ", I would like to invite you to the Dinner tonight "));
});
console.log("Mr ".concat(cannotAttend, ", cannot come to the Dinner\n"));
...
// bigger dinner table.*/
like.map(function (person) {
    console.log("Hey ".concat(person, ",I have found a Bigger Dinner Table So, Now I would Like to Invite Three Peoples more. "));
});
console.log('\n');
...
console.log("".concat(like.length, " peoples are invited to Dinner"));
